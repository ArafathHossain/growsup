                ...
                <div class="row vertical_content_manage mt-5">
                    ...
                    <div class="col-lg-6">
                        <div class="img_about mt-3">
                            <img src="{{ !empty(Auth::user()->profile_photo_path) ? url('storage/' . Auth::user()->profile_photo_path) : url('uploads/noImageFound.png') }}" alt="" class="img-fluid mx-auto d-block"
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-4">
                        <div class="about_content_box_all mt-3">
                            <div class="about_detail text-center">
                                <div class="about_icon">
                                    <img src="images/marketing_partner.png" alt=""
                                        style="border-radius: 50%; box-shadow: rgba(7, 7, 7, 0.8) 0 0 12px;">
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="about_content_box_all mt-3">
                            <div class="about_detail text-center">
                                <div class="about_icon">
                                    <img src="images/digital_audit-min.png" alt=""
                                        style="border-radius: 50%; box-shadow: rgba(7, 7, 7, 0.8) 0 0 12px;">
                                </div>
